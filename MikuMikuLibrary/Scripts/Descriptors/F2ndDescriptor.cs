...
{
    internal class F2ndDescriptor : FormatDescriptor
    {
        private static F2ndDescriptor instance;

        public static F2ndDescriptor Instance => instance ?? (instance = new F2ndDescriptor());
        ...
        public override CommandInfo[] CommandData { get; } =
        {
            ...
            new CommandInfo(0x54, -1, 000, "RESERVE"),
            new CommandInfo(0x55, -1, 002, "PV_AUTH_LIGHT_PRIORITY"),
            new CommandInfo(0x56, -1, 003, "PV_CHARA_LIGHT"),
            new CommandInfo(0x57, -1, 003, "PV_STAGE_LIGHT"),
            new CommandInfo(0x58, -1, 011, "TARGET_EFFECT"),
            new CommandInfo(0x59, -1, 003, "FOG"),
            new CommandInfo(0x5A, -1, 002, "BLOOM"),
            new CommandInfo(0x5B, -1, 003, "COLOR_CORRECTION"),
            new CommandInfo(0x5C, -1, 003, "DOF"),
            new CommandInfo(0x5D, -1, 004, "CHARA_ALPHA"),
            new CommandInfo(0x5E, -1, 001, "AUTO_CAPTURE_BEGIN"),
            new CommandInfo(0x5F, -1, 001, "MANUAL_CAPTURE"),
            new CommandInfo(0x60, -1, 003, "TOON_EDGE"),
            new CommandInfo(0x61, -1, 003, "SHIMMER"),
            new CommandInfo(0x62, -1, 004, "ITEM_ALPHA"),
            new CommandInfo(0x63, -1, 001, "MOVIE_CUT"),
            new CommandInfo(0x64, -1, 112, "EDIT_CAMERA_BOX"),
            new CommandInfo(0x65, -1, 001, "EDIT_STAGE_PARAM"),
            new CommandInfo(0x66, -1, 001, "EDIT_CHANGE_FIELD"),
            new CommandInfo(0x67, -1, 007, "MIKUDAYO_ADJUST"),
        };
    }
}
